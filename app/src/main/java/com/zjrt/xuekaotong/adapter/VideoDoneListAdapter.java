 ...
 */
public class VideoDoneListAdapter extends BaseAdapter {
    ...
    public VideoDoneListAdapter(Context context, List<DownloadFinished> list) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(
                    R.layout.video_done_list_item, null);
    ...
    public static void setIsSelected(HashMap<Integer, Boolean> isSelected) {
        VideoDoneListAdapter.isSelected = isSelected;
    }
}
